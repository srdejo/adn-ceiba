...
public class ServicioActualizarDetallePedido {
    ...
    public ServicioActualizarDetallePedido(RepositorioDetallePedido repositorioDetallePedido, RepositorioProducto repositorioProducto, RepositorioHorario repositorioHorario) {
    ...
    public void ejecutar(DetallePedido detallePedido) {
        ...
        this.repositorioDetallePedido.actualizar(detallePedido);
    }

...
public class ServicioCrearPedidoTest {
    ...
    @Test
    public void validarPedidoConDomicilioTest() {
        // arrange
        ...
        ServicioCrearPedido servicioCrearPedido = new ServicioCrearPedido(repositorioPedido, repositorioCliente, daoPedido);
        // act
    ...
    public void validarClienteExisteTest() {
        ...
        ServicioCrearPedido servicioCrearPedido = new ServicioCrearPedido(repositorioPedido, repositorioCliente, daoPedido);
        // act - assert
        BasePrueba.assertThrows(() -> servicioCrearPedido.ejecutar(pedido), ExcepcionSinDatos.class, "No sé encontró el cliente para asignar el pedido");
    }
}

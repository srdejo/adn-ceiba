...
public class BeanServicio {
    ...
    public ServicioCrearDetallePedido servicioCrearDetallePedido(RepositorioDetallePedido repositorioDetallePedido
            ...
            , DaoOferta daoOferta) {
        return new ServicioCrearDetallePedido(repositorioDetallePedido, repositorioProducto, repositorioHorario, daoOferta);
    }
    ...
    @Bean
    public ServicioConsultarPedido servicioConsultarPedido(DaoPedido daoPedido, DaoDetallePedido daoDetallePedido) {
        return new ServicioConsultarPedido(daoPedido, daoDetallePedido);
    }
